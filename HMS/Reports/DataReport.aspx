<%@ Page Language="C#" AutoEventWireup="True" EnableEventValidation="false" Inherits="HMS.DataReport"
    CodeBehind="DataReport.aspx.cs" %>
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlActive" runat="server" CssClass="CTextBox" Width="200px">
